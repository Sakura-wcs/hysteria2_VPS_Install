...
print_header() {
    clear
    echo -e "${CYAN}================================================${NC}"
    echo -e "${CYAN}           Hysteria2 配置管理脚本 v${SCRIPT_VERSION}${NC}"
    echo -e "${CYAN}================================================${NC}"
    echo ""
}
...
generate_self_signed_cert() {
    ...
    # 设置证书文件路径
    local cert_dir="/etc/hysteria2/certs/custom"
...
uninstall_everything() {
    ...
    echo "curl -fsSL https://raw.githubusercontent.com/Sakura-wcs/hysteria2_VPS_Install/main/quick-install.sh | sudo bash"
    echo ""
...
about_script() {
    ...
    echo "• GitHub: https://github.com/Sakura-wcs/hysteria2_VPS_Install"
...
certificate_management() {
    while true; do
        ...
        case $choice in
            ...
            5) manage_certificate_paths ;;
            6)
                if safe_source_script "$SCRIPTS_DIR/certificate-sync.sh" "证书同步模块"; then
